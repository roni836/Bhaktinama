    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.products.create') }}" class="btn-gradient text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded object-cover" 
                                         src="{{ $product->image ? asset($product->image) : 'https://placehold.co/40x40/FFDDC1/FF7B00?text=P' }}" 
                                         alt="{{ $product->name }}">
                                </div>
                                <div class="ml-4">
