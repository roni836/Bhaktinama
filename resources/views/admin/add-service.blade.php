        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a href="#" id="openCategoryModal"
                    class="text-orange-500 text-sm font-medium hover:text-orange-600"> + Service Category
                </a>
                ...
                <div>
                    <label for="location_id" class="block text-sm font-medium text-gray-700 mb-2">Location (State)</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="overview" name="overview" rows="4" placeholder="Enter the Overview About service"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('overview') }}</textarea>
                    @error('overview')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Enter the Description"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    <label for="duration" class="block text-sm font-medium text-gray-700 mb-2">Visiting Information</label>
                    <input type="text" id="duration" name="duration" placeholder="Enter the visiting information"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500" value="{{ old('duration') }}">
                    @error('duration')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    <label for="significance" class="block text-sm font-medium text-gray-700 mb-2">Traditions & Cultural
                        Significance</label>
                    <textarea id="significance" name="significance" rows="4" placeholder="Enter Traditions & Cultural Significance"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">{{ old('significance') }}</textarea>
                    @error('significance')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div id="packages-container">
                        <div class="package-row flex gap-4 mb-3">
                            ...
                            <div class="flex-1">
                                <input type="number" name="packages[0][discount_price]" placeholder="Enter the  discount price"
                                    step="0.01"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">
                            </div>
                        </div>
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_trending" value="1"
                            {{ old('is_trending', true) ? 'checked' : '' }} class="mr-2">
