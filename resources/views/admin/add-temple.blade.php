...
@section('content')
<div class="max-w-6xl mx-auto bg-white font-sans">

    <div class="flex bg-white font-sans">

        <!-- Left Side Image -->
        <div class="hidden md:block w-1/2 bg-orange-400 relative">
            <img src="\peakpx (3).png"
                alt="Temple Image"
                class="w-full h-full object-cover mix-blend-overlay opacity-1">
        </div>
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-10">
            ...
            <!-- Form -->
            <form action="{{ route('admin.temples.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                ...
                <a href="#"
                    class="text-orange-500 text-sm hover:underline">+ Add package</a>
                ...
                <a href="{{ route('admin.pandits.create') }}" class="text-orange-500 text-sm hover:underline">+ Pandit</a>
