    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-orange-50 p-6 rounded-lg">
                ...
                <a href="" class="mt-4 inline-block text-orange-500 hover:underline">Book Now</a>
            </div>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="bg-gray-50 p-4 rounded-lg text-center">
                ...
                <a href="" class="mt-2 inline-block text-orange-500 hover:underline">Book a Pandit</a>
            </div>
        </div>
    </div>
</div>
